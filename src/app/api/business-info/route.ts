...
export async function GET(req: Request) {
        ...
        try {
                ...
                const detailsUrl = `https://maps.googleapis.com/maps/api/place/details/json?place_id=${place.place_id
                        }&fields=name,rating,user_ratings_total,reviews,formatted_address,url,geometry,photos,editorial_summary,formatted_phone_number,international_phone_number,website,opening_hours,profile&key=${apiKey}`;
